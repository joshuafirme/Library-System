    ...
    <div class="page-header">
        <h3 class="mt-2" id="page-title">Book Maintenance</h3>
              ...
              <div class="row">
                ...
                <div class="col-sm-2 col-md-2 col-lg-12 mb-3">
                  <form action="{{ action('Maintenance\BookCtr@export') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addBookModal" id="btn-add-book"><span class='fa fa-plus'></span> Add book</a> 
                    <a class="btn btn-success btn-sm" data-toggle="modal" data-target="#importModal"><span class='fa fa-file-excel'></span> Import CSV</a> 
                    <button type="submit" class="btn btn-warning btn-sm"><span class='fa fa-file-export'></span> Export CSV</button> 
                    </form>
