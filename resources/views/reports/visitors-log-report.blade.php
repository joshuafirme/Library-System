...
<div class="container-fluid">
    <div class="page-header">
        <h3 class="mt-2" id="page-title">Visitor's Log Report</h3>
                <hr>
            </div>
              ...
              <div class="row">
                <div class="col-sm-2 col-md-2 col-lg-10 mb-3">
                    <button class="btn btn-danger btn-sm"id="btn-visitors-log-print"><span class='fa fa-print'></span> Print</button>
                </div>
                    ...
                    <div class="row mb-2">
                      ...
                      <div class="col-sm-2 mb-3">
                        ...
                        <div class="col-sm-2 mb-3">
                          ...
                          <table class="table table-data responsive  table-hover" id="visitors-log-report-table">                               
                            <thead>
                              <tr>
                                  <th>User ID</th>
                                  <th>Name</th>
