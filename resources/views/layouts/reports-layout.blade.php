...
<body id="page-top">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; SRAPS 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="{{asset('vendor/jquery3/jquery.min.js')}}"></script>
    ...
    <script src="{{asset('js/reports/visitors-log-report.js')}}"></script>
